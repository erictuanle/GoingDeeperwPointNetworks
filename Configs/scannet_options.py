...
class ScannetOptions(BaseOptions):
    
    def initialize(self, parser):
        parser = BaseOptions.initialize(self, parser)
        parser.add_argument('--indir', type=str, default='/mnt/Data/scannet/', help='input folder')
        parser.add_argument('--num_classes', type=int, default=None, help='number of object categories')
        parser.add_argument('--num_parts', type=int, default=21, help='number of object categories')
        parser.add_argument('--num_points_training', type=int, default=8192, help='number of points to use for training')
    ...
    def initialize_pointnet2(self, parser):
        parser.add_argument('--name', type=str, default='training_pointnet2_scannet', help='training run name')
        parser.add_argument('--desc', type=str, default='My training on ScanNet with Pointnet++.', help='description')
    ...
    def initialize_mRes(self, parser):
        parser.add_argument('--name', type=str, default='training_mres_scannet', help='training run name')
        parser.add_argument('--desc', type=str, default='My training on ScanNet with mRes.', help='description')
        parser.add_argument('--refine', type=str, default='', help='refine model at this path')
        parser.add_argument('--batch_size', type=int, default=8, help='maximum number of samples within a batch')
    ...
    def initialize_mResX(self, parser):
        parser.add_argument('--name', type=str, default='training_mresx_scannet', help='training run name')
        parser.add_argument('--desc', type=str, default='My training on ScanNet with mResX.', help='description')
        parser.add_argument('--refine', type=str, default='', help='refine model at this path')
        parser.add_argument('--batch_size', type=int, default=8, help='maximum number of samples within a batch')
        parser.add_argument('--nb_subsampled_points', type=lambda x: eval(x), default=[[512, 256, 128],
                                                                                       [128, 96, 64],
    ...
    def initialize_convPN(self, parser):
        parser.add_argument('--name', type=str, default='training_convpn_scannet', help='training run name')
        parser.add_argument('--desc', type=str, default='My training on ScanNet with convPN.', help='description')
        parser.add_argument('--refine', type=str, default='', help='refine model at this path')
        parser.add_argument('--batch_size', type=int, default=8, help='maximum number of samples within a batch')
        parser.add_argument('--nb_subsampled_points', type=lambda x: eval(x), default=[[512, 256, 128],
    ...
    def initialize_deepConvPN(self, parser):
        parser.add_argument('--name', type=str, default='training_deepconvpn_scannet', help='training run name')
        parser.add_argument('--desc', type=str, default='My training on ScanNet with deepConvPN.', help='description')
        parser.add_argument('--refine', type=str, default='', help='refine model at this path')
        parser.add_argument('--batch_size', type=int, default=8, help='maximum number of samples within a batch')
        parser.add_argument('--nb_subsampled_points', type=lambda x: eval(x), default=[[512, 256, 128],
                                                                                       [128, 96, 64]], help='resolution of the point cloud at each of the encoding steps (3 non increasing lists)')
